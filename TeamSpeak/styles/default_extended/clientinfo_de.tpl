...
<table id="info">
  ...
  <tr>
    <td class="label">Eindeutige ID:</td>
    <td>%%CLIENT_UNIQUE_ID%%</td>
  </tr>
  <tr>
    <td class="label">Datenbank ID:</td>
  ...
  <tr>
	...
	<td>%%CLIENT_VERSION%% %%CLIENT_VERSION_STATE%% auf <img src="styles:/default_extended/media/%%CLIENT_PLATFORM%%.png" alt="" title="%%CLIENT_PLATFORM%%" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="label">Erste Verbindung:</td>
...
<table id="list">
  <tr><td class="space label"><img src="iconpath:16x16_permissions_server_groups.png" height="12" width="12" alt=""> Server Gruppen:</td></tr>
  <tr><td class="list">
    <div>%%CLIENT_SERVER_GROUP_ICON%% %%CLIENT_SERVER_GROUP_NAME%%</span></div>
  </td></tr>
  <tr><td class="space label"><img src="iconpath:16x16_permissions_channel_groups.png" height="12" width="12" alt=""> Channel Gruppe:</td></tr>
  <tr><td class="list">
    <div>%%CLIENT_CHANNEL_GROUP_ICON%% %%CLIENT_CHANNEL_GROUP_NAME%%</div>
  </td></tr>
  <tr><td class="red"><br />*** Client hat um <b>%%?CLIENT_TALK_REQUEST_TIME%%</b> Talk Power angefordert.</td></tr>
